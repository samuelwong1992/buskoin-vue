<template>
  <div class="profile">
	<StripeCheckout ref="checkoutRef" pk="pk_test_51IXzZ1HfGkYzo1kqXdmETsXtFVJHnBz9Fx4kFxBdm4sW5qVQUJW61fjWs2ppM5w2Ep779xDI5j4EMYimlS7VGvvY00yx2gYEDt" :sessionId="sessionId"/>
  <div class="profile-container" v-if="!errorMessage">
    ...
    <div class="button-container">
      ...
      <button v-if="!isCustom" v-on:click="isCustom = !isCustom">Custom</button>
...
export default {
  ...
  methods: {
    createPayment: function(value) {
      ...
      this.axios.post(this.$hostname + "api/create-payment/", formData, {
        headers: {
  ...
  mounted: function() {
    this.$nextTick(() => {
      this.axios.get(this.$hostname + "api/fetch-profile/" + this.$route.params.id + "/", {
        headers: {
        "Content-Type": "application/json",
        }
      }).then(response => {
